...
int LeftDownArm::Late_Update()
{
	return 0;
}

void LeftDownArm::Render(HDC hDC)
{
...
void LeftDownArm::Release()
{
}

void LeftDownArm::Key_Input()
{
}
